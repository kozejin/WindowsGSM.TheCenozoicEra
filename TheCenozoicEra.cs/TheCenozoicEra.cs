...
{
    public class TheCenozoicEra : SteamCMDAgent
    {
        // - Plugin Details
        public Plugin Plugin = new Plugin
        {
            name = "WindowsGSM.TheCenozoicEra", // WindowsGSM.XXXX
            author = "Koz",
            description = "WindowsGSM plugin for supporting The Cenozoic Era Dedicated Server",
            version = "1.1",
            url = "https://github.com/dkoz/WindowsGSM.TheCenozoicEra", // Github repository link (Best practice)
            color = "#34c9eb" // Color Hex
        };

        // - Settings properties for SteamCMD installer
        public override bool loginAnonymous => false;
        public override string AppId => "2241720"; // Game server appId, TheCenozoicEra is 412680 -beta evrima

        // - Standard Constructor and properties
        public TheCenozoicEra(ServerConfig serverData) : base(serverData) => base.serverData = _serverData = serverData;
        private readonly ServerConfig _serverData;
        public string Error, Notice;


        // - Game server Fixed variables
        public override string StartPath => @"TheCenozoicEra\Binaries\Win64\TheCenozoicEraServer.exe"; // Game server start path
        public string FullName = "The Cenozoic Era"; // Game server FullName
        ...
        public string Port = "21515"; // Default port
        public string QueryPort = "21518"; // Default query port
        ...
        {
            string configPath = Functions.ServerPath.GetServersServerFiles(_serverData.ServerID, @"TheCenozoicEra\Saved\Config\WindowsServer\Game.ini");
        ...
        public async Task<Process> Start()
        {
            ...
            string win64 = Path.Combine(ServerPath.GetServersServerFiles(_serverData.ServerID, @"TheCenozoicEra\Binaries\Win64\"));
        ...
        public static async Task<bool> DownloadGameServerConfig(string fileSource, string filePath)
        {
            ...
            try
            {
                ...
                {
                    await webClient.DownloadFileTaskAsync($"https://raw.githubusercontent.com/kozejin/WindowsGSM-Configs/main/TheCenozoicEra/Game.ini", filePath);
                }
            }
            catch (Exception e)
            {
